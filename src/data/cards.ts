...
{ id:6, category:"closeness", title:"שלושה דברים", type:"text", text:"כל אחד אומר לבן הזוג:\n1. דבר אחד שהוא אוהב בגוף שלו.\n2. דבר אחד שהוא אוהב באופי שלו.\n3. דבר אחד שהוא אוהב בקשר שלכם." },
...
{ id:17, category:"bold", title:"מכיר אותי?", type:"text", text:"משחק תורות:\nכל אחד בתורו אומר לבן הזוג 3 דברים שמדליקים אותו או שהוא היה רוצה לנסות.\n1 אמיתי ו-2 מומצאים.\nבן הזוג צריך לנחש מה הדבר האמיתי.\nאם ניחש נכון – הוא בוחר: לעשות את מה שמדליק את בן הזוג או את מה שמדליק אותו.\nאם טועה – עושים את מה שמדליק את בן הזוג.\nאחר כך עוברים לתור של בן הזוג השני." },
